...
export const EastCalendarReducer = (state = InitState, action) => {

    switch (action.type) {
        case "GET_INFOS_EASTCALENDAR":
        ...
        case "ADD_TRUCKS_NEWROW_EASTCALENDAR":
            return { ...state, trucks: action.payload.trucks };

        case "ADD_LOAD_NEWROW_EASTCALENDAR":
            return { ...state, load: action.payload.load };

        case "NEW_WEEKLYCALENDAR_ROW_EASTCALENDAR":
        ...
        case "UNDISPATCHED_EASTCALENDAR":
            changeDateType(action.payload.dispatchedInfos);
            let undispatch = [];
            state.weeklyCalendarInfos.forEach((info)=>{
        ...
        case "DELETED_TRUCKS_INFO_EASTCALENDAR":
        ...
        case "DELETED_LOAD_INFO_EASTCALENDAR":
            changeDateType(action.payload.changedInfos);
            let loadChanged = [];
            state.weeklyCalendarInfos.forEach((info)=>{
        ...
        case "DELETED_LOAD_ADDINFO_EASTCALENDAR":
            changeDateType(action.payload.changedInfos);
            let loadInfoChanged = [];
            state.weeklyCalendarInfos.forEach((info)=>{
        ...
        case "DRAG_AND_DROP_EASTCALENDAR":
        ...
        case "UPDATED_TRUCKS_EASTCALENDAR":
        ...
        case "ADDED_TRUCKINFO_EASTCALENDAR":
            changeDateType(action.payload.updatedTrucks);
        ...
        case "ADDED_LOADINFO_EASTCALENDAR":
        ...
        case "ADD_LOADINFO_EASTCALENDAR":
            ToastHandler(action.payload)
            return state;

        case "UPDATED_LOAD_EASTCALENDAR":
            changeDateType(action.payload.updatedLoad);
            let updatedByLoad = [];
            state.weeklyCalendarInfos.forEach((info)=>{
        ...
        case "CHANEGED_TRUCK_COLOR_EASTCALENDAR":
            changeDateType(action.payload.updatedTrucks);
        ...
        case "CHANEGED_LOAD_COLOR_EASTCALENDAR":
            changeDateType(action.payload.updatedLoad);
        ...
        case "EDIT_CALENDAR_TEXT_EASTCALENDAR":
            return { ...state, calendarTexts: action.payload.calendarText };
            
        case "ADD_CALENDAR_TEXT_EASTCALENDAR":
            return { ...state, calendarTexts: action.payload.calendarText };

        case "DELETE_CALENDAR_TEXT_EASTCALENDAR":
            return { ...state, calendarTexts: action.payload.calendarText };

        case "EDIT_TRUCK_MODAL_EASTCALENDAR":
            return {
                ...state,
        ...
        case "EDIT_LOAD_MODAL_EASTCALENDAR":
            return {
                ...state,
