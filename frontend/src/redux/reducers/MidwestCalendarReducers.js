...
export const MidwestCalendarReducer = (state = InitState, action) => {

    switch (action.type) {
        case "GET_INFOS_MIDWESTCALENDAR":
        ...
        case "ADD_TRUCKS_NEWROW_MIDWESTCALENDAR":
            return { ...state, trucks: action.payload.trucks };

        case "ADD_LOAD_NEWROW_MIDWESTCALENDAR":
            return { ...state, load: action.payload.load };

        case "NEW_WEEKLYCALENDAR_ROW_MIDWESTCALENDAR":
        ...
        case "UNDISPATCHED_MIDWESTCALENDAR":
            changeDateType(action.payload.dispatchedInfos);
            let undispatch = [];
            state.weeklyCalendarInfos.forEach((info)=>{
        ...
        case "DELETED_TRUCKS_INFO_MIDWESTCALENDAR":
        ...
        case "DELETED_LOAD_INFO_MIDWESTCALENDAR":
            changeDateType(action.payload.changedInfos);
            let loadChanged = [];
            state.weeklyCalendarInfos.forEach((info)=>{
        ...
        case "DELETED_LOAD_ADDINFO_MIDWESTCALENDAR":
            changeDateType(action.payload.changedInfos);
            let loadInfoChanged = [];
            state.weeklyCalendarInfos.forEach((info)=>{
        ...
        case "DRAG_AND_DROP_MIDWESTCALENDAR":
        ...
        case "UPDATED_TRUCKS_MIDWESTCALENDAR":
        ...
        case "ADDED_TRUCKINFO_MIDWESTCALENDAR":
            changeDateType(action.payload.updatedTrucks);
        ...
        case "ADDED_LOADINFO_MIDWESTCALENDAR":
        ...
        case "ADD_LOADINFO_MIDWESTCALENDAR":
            ToastHandler(action.payload)
            return state;

        case "UPDATED_LOAD_MIDWESTCALENDAR":
            changeDateType(action.payload.updatedLoad);
            let updatedByLoad = [];
            state.weeklyCalendarInfos.forEach((info)=>{
        ...
        case "CHANEGED_TRUCK_COLOR_MIDWESTCALENDAR":
            changeDateType(action.payload.updatedTrucks);
        ...
        case "CHANEGED_LOAD_COLOR_MIDWESTCALENDAR":
            changeDateType(action.payload.updatedLoad);
        ...
        case "EDIT_CALENDAR_TEXT_MIDWESTCALENDAR":
            return { ...state, calendarTexts: action.payload.calendarText };
            
        case "ADD_CALENDAR_TEXT_MIDWESTCALENDAR":
            return { ...state, calendarTexts: action.payload.calendarText };

        case "DELETE_CALENDAR_TEXT_MIDWESTCALENDAR":
                return { ...state, calendarTexts: action.payload.calendarText };

        case "EDIT_TRUCK_MODAL_MIDWESTCALENDAR":
            return {
                ...state,
        ...
        case "EDIT_LOAD_MODAL_MIDWESTCALENDAR":
            return {
                ...state,
        ...
        case "EDIT_MIDWESTNOTEPAD_MODAL":
