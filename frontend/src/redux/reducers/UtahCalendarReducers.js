...
export const UtahCalendarReducer = (state = InitState, action) => {

    switch (action.type) {
        case "GET_INFOS_UTAHCALENDAR":
        ...
        case "ADD_TRUCKS_NEWROW_UTAHCALENDAR":
            return { ...state, trucks: action.payload.trucks };

        case "ADD_LOAD_NEWROW_UTAHCALENDAR":
            return { ...state, load: action.payload.load };

        case "NEW_WEEKLYCALENDAR_ROW_UTAHCALENDAR":
        ...
        case "UNDISPATCHED_UTAHCALENDAR":
            changeDateType(action.payload.dispatchedInfos);
            let undispatch = [];
            state.weeklyCalendarInfos.forEach((info)=>{
        ...
        case "DELETED_TRUCKS_INFO_UTAHCALENDAR":
        ...
        case "DELETED_LOAD_INFO_UTAHCALENDAR":
            changeDateType(action.payload.changedInfos);
            let loadChanged = [];
            state.weeklyCalendarInfos.forEach((info)=>{
        ...
        case "DELETED_LOAD_ADDINFO_UTAHCALENDAR":
            changeDateType(action.payload.changedInfos);
            let loadInfoChanged = [];
            state.weeklyCalendarInfos.forEach((info)=>{
        ...
        case "DRAG_AND_DROP_UTAHCALENDAR":
        ...
        case "UPDATED_TRUCKS_UTAHCALENDAR":
        ...
        case "ADDED_TRUCKINFO_UTAHCALENDAR":
            changeDateType(action.payload.updatedTrucks);
        ...
        case "ADDED_LOADINFO_UTAHCALENDAR":
        ...
        case "ADD_LOADINFO_UTAHCALENDAR":
            ToastHandler(action.payload)
            return state;

        case "UPDATED_LOAD_UTAHCALENDAR":
            changeDateType(action.payload.updatedLoad);
            let updatedByLoad = [];
            state.weeklyCalendarInfos.forEach((info)=>{
        ...
        case "CHANEGED_TRUCK_COLOR_UTAHCALENDAR":
            changeDateType(action.payload.updatedTrucks);
        ...
        case "CHANEGED_LOAD_COLOR_UTAHCALENDAR":
            changeDateType(action.payload.updatedLoad);
        ...
        case "EDIT_CALENDAR_TEXT_UTAHCALENDAR":
            return { ...state, calendarTexts: action.payload.calendarText };
            
        case "ADD_CALENDAR_TEXT_UTAHCALENDAR":
            return { ...state, calendarTexts: action.payload.calendarText };

        case "DELETE_CALENDAR_TEXT_UTAHCALENDAR":
            return { ...state, calendarTexts: action.payload.calendarText };

        case "EDIT_TRUCK_MODAL_UTAHCALENDAR":
            return {
                ...state,
        ...
        case "EDIT_LOAD_MODAL_UTAHCALENDAR":
            return {
                ...state,
