...
import { AddCalendarTextMidwestCalendar } from "../../redux/actions/MidwestCalendarActions";
...
export default function MidwestNoteAddDialog({ children }) {
    ...
    const OnSubmitHandler = async (e) => {
        e.preventDefault()
        dispatch(AddCalendarTextMidwestCalendar(text, token));
        setOpen(false);
        setText("");
    }
