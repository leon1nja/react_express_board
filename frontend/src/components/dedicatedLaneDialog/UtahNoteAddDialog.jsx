...
import { AddCalendarTextUtahCalendar } from "../../redux/actions/UtahCalendarActions";
...
export default function UtahNoteAddDialog({ children }) {
    ...
    const OnSubmitHandler = async (e) => {
        e.preventDefault()
        dispatch(AddCalendarTextUtahCalendar(text, token));
        setOpen(false);
        setText("");
    }
