...
import { AddCalendarTextColoradoCalendar } from "../../redux/actions/ColoradoCalendarActions";
...
export default function ColoradoNoteAddDialog({ children }) {
    ...
    const OnSubmitHandler = async (e) => {
        e.preventDefault()
        dispatch(AddCalendarTextColoradoCalendar(text, token));
        setOpen(false);
        setText("");
    }
