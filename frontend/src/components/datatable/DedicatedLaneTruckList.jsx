import "./DedicatedLaneTruckList.scss";
...
import HelperText from "../dialog/Helper";


const DedicatedLaneTruckList = () => {
    ...
    const trucklistCounter = trucks.length;
    ...
    return (
        <div className="datatable2">
            <div className="datatableTitle">
                Daily Trucklist
                <h4 className="trucklistCounter"> Total : {trucklistCounter} trucks</h4> 
            ...
            <DataGrid
                ...
                initialState={{
                    sorting: {
                        sortModel: [{ field: 'daySort', sort: 'asc' }],
                      },
                }}
                // rowHeight={40}
                sx={{
...
export default DedicatedLaneTruckList;
