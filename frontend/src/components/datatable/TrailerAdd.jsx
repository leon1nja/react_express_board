...
import { trailerListInputs } from "../../formSource";
import { useDispatch, useSelector } from "react-redux";
import { AddTrailerListAction } from "../../redux/actions/ListActions";
...
export default function TrailerAdd({ children }) {
  ...
  const OnSubmitHandler = async (e) => {
    ...
    dispatch(AddTrailerListAction(state, token))
    setOpen(false);
